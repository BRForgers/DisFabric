...
public class Configuration implements ConfigData {
    ...
    @Comment(value = "If you activated SERVER MEMBERS INTENT in the bot, change it to true, this is only necessary if you wanted to activate the mentions by the server")
    @ConfigEntry.Category(value = "Discord")
    public boolean membersIntents = false;

    @Comment(value = "Announces the join and left of players")
    @ConfigEntry.Category(value = "Discord")
    public boolean announcePlayers = true;

    @Comment(value = "Announces the advancements of players")
    @ConfigEntry.Category(value = "Discord")
    public boolean announceAdvancements = true;

    @Comment(value = "Announces the deaths of players")
    @ConfigEntry.Category(value = "Discord")
    ...
    public static class Texts {
        ...
        @Comment(value = "Minecraft -> Discord\n"+
                ...
                "Available placeholders:\n"+
                "%playername% | Player name\n"+
                "%deathmessage% | Death message (is generated by minecraft)")
        @ConfigEntry.Category(value = "Texts")
